...
def main():
    ...
    panel = [
        ...
        (110, kv(["Kernel"], "AI/ML & Signal Processing Engineer")),
        ...
        (210, kv(["Languages", "Real"], "English, Swedish")),
        (230, [seg(". ", "cc")]),
        ...
        (470, two_col("Repos", str(s["repos"]), None,
                      "Commits", fmt(s["commits"]))),
        (490, kv(["Award"], "IEEE ISIT 2025 D2I — 3rd Place")),
